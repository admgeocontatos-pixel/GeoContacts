...
const bundleId = "com.app.geocontacts";
...
export const getLoginUrl = () => {
  if (!isOAuthConfigured()) {
    throw new Error("Login externo não configurado: defina EXPO_PUBLIC_OAUTH_PORTAL_URL e EXPO_PUBLIC_APP_ID no ambiente do app.");
  }
